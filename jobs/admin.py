...
class JobPostingAdmin(admin.ModelAdmin):
    list_display = ['title', 'recruiter', 'location', 'is_remote', 'status', 'moderation_status', 'created_at']
    list_filter = ['status', 'moderation_status', 'is_remote', 'visa_sponsorship', 'created_at']
